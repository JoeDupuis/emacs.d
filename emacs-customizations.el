...
(custom-set-variables
 ...
 '(magit-gitflow-release-finish-arguments (quote ("--push")))
 '(menu-bar-mode nil)
 '(package-archive-priorities (quote (("gnu" . 5) ("melpa" . 3))))
 '(package-selected-packages
	 (quote
		(company-tabnine company-nixos-options pdf-tools dired-rsync nix-mode js2-mode ledger-mode php-mode company web-mode exec-path-from-shell restclient minitest ruby-end electric-pair flx-ido markdown-mode csharp-mode flycheck yaml-mode rails-log-mode projectile-rails projectile highlight-indentation wgrep-ag goto-chg magit-gitflow buffer-move ag monokai-alt-theme monokai-theme use-package magit color-theme-sanityinc-tomorrow)))
